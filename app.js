...
const maxOfTwoNumbers = (x, y) => {
  ...
  console.log('Exercise 1 Result:', maxOfTwoNumbers(3, 10));
  /*
Exercise 2: isAdult()
...
const isCharAVowel = charachter => {
    if (charachter.toLowerCase() === 'e' ||
    charachter.toLowerCase() === 'o' ||
    charachter.toLowerCase() === 'a' ||
    charachter.toLowerCase() === 'i' ||
    charachter.toLowerCase() === 'u'){
    return true
}
else{
    return false
...
const generateEmail = (emailName, emailDomain) => {return `${emailName}@${emailDomain}`}
...
const greetUser = (greetingName, TimeOfDay) => {
        return `Good ${TimeOfDay.toLowerCase()}, ${greetingName}!`
}
...
const createUsername = (firstName, lastName) => {
    let con1 = firstName.substring(0,3)
    let con2 = lastName.substring(0,3)
    let count = firstName.length + lastName.length

    return `${con1}${con2}${count}`
}

console.log('Exercise 11 Result:', createUsername("Samantha", "Green"));
console.log('Exercise 11 Result:', createUsername("Sara", "Faqeeh"));
...
const numArgs = (... numArgs) => {
    let count=0
    for (let i=0; i<numArgs.length; i++){
        count = count + numArgs[i]
    }
    return count;
}
